...
$html = '<p style="border-bottom: 1px solid #999999; font-size: 9pt;">Sorry No payment record found kindly go to the school microfinace bank to make this payment !</p>';

if($totalRows_history > 0) {
    $html ='<p style="text-align:center; font-size: 20pt; margin-bottom: 30px"><strong>GRADUANDS FEE PAYMENT RECEIPT</strong></p>
    <div style="text-align:center; width:100%; font-size: 20pt">
        <table align="center" style="width: 60%;" class="table table-bordered table-striped">
           ...
           <tr>
                ...
                <td>Description:</td>
                <td>GRADUAND PAYMENT RECEIPT</td>
...
<p><h6> Students are to note that the payment for the Graduation fee is Non-Refundable and Non-Transferable. </h6> </p>
    </div>';
}
