...
if($totalRows_last_reg > 0) {   
    ...
    $query_clear_fee = sprintf("SELECT matric_no "
                                . "FROM clearance_transactions "
                                . "WHERE matric_no = %s AND status = 'APPROVED' ", 
                                GetSQLValueString($stdid, "text"));
                                        ...
                                        <p>REASON: 
                                            <?php 
                                                $responses = [
                                                    ...
                                                    'unclear' => 'There is no record of your  '
                                                ];
                            ...
                            <table width="670">
                                <tr>
                                    <td size="30">
                                        ...
                                        <strong>'.$row_student['deptname'].'</strong> has been verified. </span></p>
                                    </td>
                                </tr>
