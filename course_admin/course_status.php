...
if (isset($_POST["submit"]) && $progid != '') {
    ...
    if (isset($_POST['inserted'])) {
        ...
        foreach ($_POST['inserted'] as $values) {
            ...
            $insert_entries[] = sprintf("(%s, %s, %s, %s, %s, %s)",
                                        GetSQLValueString($progid, "int"),
                                        GetSQLValueString($deptid, "int"),
                                        GetSQLValueString($values['csid'], "text"),
        ...
        $insertSQL = sprintf("INSERT INTO department_course (progid, deptid, csid, status, unit, level) VALUES %s;", 
                            ...
                            <div class="box box-bordered box-color">
                                ...
                                <div class="box-content">                                 
                                    ...
                                    <form name="assignform" action='' method="post">
                                        <fieldset>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tr ng-repeat="course in newCourses">
                                                    ...
                                                    <input type="hidden" name="inserted[{{$index}}][csid]" value="{{course.csid}}"/>
                                                </tr>
                                                ...
                                                <tr ng-repeat="course in courses">
                                                    ...
                                                    <td>
                                                        <select name="courses[{{course.assignid}}][level]" class="input-small" ng-model="course.level" ng-disabled="!course.edit">
                                                            <?php for ($idx = 1; $idx <= $prog_list[$progid][1]; $idx++) :?>
                                                            <option value="<?php echo $idx ?>">
                                                            <?php echo $idx . '00' ?>
                                                            </option>
                                        ...
                                        <?php if (getAccess() == 1 || getAccess() == 20) { ?>
