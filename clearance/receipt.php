...
if($totalRows_history > 0) {
    $html ='<p style="text-align:center; font-size: 20pt; margin-bottom: 30px"><strong>FINAL YEAR CLEARANCE PAYMENT RECEIPT</strong></p>
    <div style="text-align:center; width:100%; font-size: 20pt">
        ...
        <p><h6> Students are to note that the payment for the Final year clearance is Non-Refundable and Non-Transferable. </h6> </p> <br/>
        <div>
