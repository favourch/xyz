                                    ...
                                    <div class="row-fluid">
                                        <div class="span6">
                                            ...
                                            <form class="form-horizontal form-column form-bordered" method="POST" action="printreport.php" target="_blank">
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="password">Level</label>
                                                    <div class="controls">
                                                        <select name="level" required="required">
                                                            <option value="">-Choose-</option>
                                                            <option value="0">Prospective</option>
                                                            <option value="1">100 L</option>
                                                            <option value="2">200 L</option>
                                                            <option value="3">300 L</option>
                                                            <option value="4">400 L</option>
                                                            <option value="5">500 L</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="utype">Session</label>
                                                    <div class="controls">
