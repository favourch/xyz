                            ...
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3><i class="icon-reorder"></i>
                                        Prospective Student O'Level Verification Page
                                    </h3>
                                    <ul class="tabs">
                                        <li class="active">
                                            <a href="my_treated.php">My Treaded</a>
                                        </li>
                                    </ul>
                                </div>
                                                        ...
                                                        <?php do { ?>
                                                            <tr>
                                                                ...
                                                                <?php }
                                                                    ...
                                                                    ?>
                                                            <form name='form1' method="POST" action="<?php echo urldecode(' index.php?id=' . $verify_row['id'] . '&stdid=' . $verify_row['stdid'] . '&ordid=' . $verify_row['ordid']) ?>">
