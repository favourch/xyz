...
$query_hod = sprintf("SELECT lname, fname, mname "
...
$query_dean = sprintf("SELECT lname, fname, mname "
...
$query_vc = sprintf("SELECT lname, fname, mname "
...
<p>THE FOLLOWING '.count($passlist).' CANDIDATE(S) 
    HAVE PASSED THE COMPULSORY AND REQUIRED COURSES AND HAVE 
            ...
            // Determining Class of Degree for PASSED Students 
                ...
                if ($std['cum']['gpa'] >= 4.50 && $std['cum']['gpa'] <= 5.00){
                    ...
                    elseif ($std['cum']['gpa'] >= 3.50 && $std['cum']['gpa'] <= 4.49){
                        $cdegree = "Second Class Upper";
                    }
                    elseif ($std['cum']['gpa'] >= 2.40 && $std['cum']['gpa'] <= 3.49){
                        $cdegree = "Second Class Lower";
                    }
