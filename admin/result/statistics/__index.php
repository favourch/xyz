...
<?php include INCPATH . "/top_nav_bar.php" ?>
        ...
        function loadGraph10(){
            ...
            for(var idx = 0; idx < dt.length; idx++){
                    ...
                    if(11 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 19 ){
                        b1=b1 +1;  
                    }
                    if(21 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 29 ){
                        c1 = c1 +1;  
                    }
                    if(31 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 39 ){
                        d1 = d1 +1;  
                    }
                    if(41 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 49 ){
                        e1 = e1 +1;  
                    }
                    if(51 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 59 ){
                        f1 = f1 +1;  
                    }
                    if(61 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 69 ){
                        g1 = g1 +1;  
                    }
                    if(71 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 79 ){
                        h1 = h1 +1;  
                    }
                    if(81 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 89 ){
                        i1 = i1 +1;  
                    }
        ...
        function loadGraph5(){
            ...
            for(var idx = 0; idx < dt.length; idx++){
                if(0 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 4 ){
                    a1 = a1 + 1;    
                }
                if(6 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 9 ){
                    b1=b1 +1;
                }
                if(11 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 14 ){
                    c1 = c1 +1; 
                }
                if(16 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 19 ){
                    d1 = d1 +1;
                }
                if(21 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 24 ){
                    e1 = e1 +1;  
                }
                if(26 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 29 ){
                    f1 = f1 +1; 
                }
                if(31 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 34 ){
                    g1 = g1 +1; 
                }
                if(36 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 39 ){
                    h1 = h1 + 1;
                }
                if(41 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 44 ){
                    i1 = i1 +1; 
                }
                if(46 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 49 ){
                    j1 = j1 +1;
                }
                if(51 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 54 ){
                    k1=k1 +1;
                }
                if(56 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 59 ){
                    l1 = l1 +1; 
                }
                if(61 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 64 ){
                    m1 = m1 +1;
                }
                if(66 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 69 ){
                    n1 = n1 +1;
                }
                if(71 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 74 ){
                    o1 = o1 +1;
                }
                if(76 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 79 ){
                    p1 = p1 +1; 
                }
                if(81 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 84 ){
                    q1 = q1 +1;
                }
                if(86 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 89 ){
                    r1 = r1 +1;  
                }
                if(91 <= parseInt(dt[idx].score) && parseInt(dt[idx].score) <= 94 ){
                    s1 = s1 + 1; 
                }
