...
$query_stud = sprintf("SELECT s.stdid, s.progid, c.colid, c.dean_email AS col_email, d.email AS dept_email, p.deptid, fname, lname, level, s.curid FROM student s, programme p, department d, college c WHERE s.progid = p.progid AND d.deptid = p.deptid AND d.colid = c.colid AND s.stdid = %s", GetSQLValueString($colname_stud, "text"));
...
if(isset($_POST['action']) && $_POST['action'] == 'add_result'){
    ...
    echo $sql = sprintf("INSERT into result (csid, sesid, stdid, tscore, escore, upload_date) VALUES (%s, %s, %s, %s, %s, %s) ",
                    GetSQLValueString($_POST['csid'], 'text'),
                    GetSQLValueString($_POST['sesid'], 'text'),
                    GetSQLValueString($_POST['stdid'], 'text'),
                    GetSQLValueString($_POST['tscore'], 'int'), 
...
// Grading conditions
$query_grad = sprintf("SELECT * FROM grading g, session s WHERE g.sesid = s.sesid AND g.colid = %s", GetSQLValueString($row_stud['colid'], "int"));
                        ...
                        <div class="span12">
                            <div class="box nopadding">
                                ...
                                <div class="box-content">
                                    <?php if ($allow) { ?>
                                    <?php if (in_array(getAccess(), [20,2,3,4,5,6])) { ?>
