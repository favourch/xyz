...
if(isset($_POST['update']) && $_POST['update'] == 'yes'){
    $transExistSQL = sprintf("SELECT matric_no "
    ...
    if($transExist_num_row > 0){
        ...
        $sql = sprintf("INSERT INTO clearance_transactions ( "
                    . "matric_no, can_no, "
                    . "can_name, reference, "
                    . "year, status, "
                    . "date_time, ordid, "
                    . "sessionid, percentPaid, "
                    ...
                    GetSQLValueString('NGN45,000.00', 'text'), 
            ...
            <form method="post" action="<?= $editFormAction; ?>">
                <div class="modal-body">
                    <div class="alert alert-warning">
                        You have choose to activate Clearance Fee Payment for the student with the bellow information
                    </div>
                    <div class="well well-small">
