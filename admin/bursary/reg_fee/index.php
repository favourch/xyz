...
$query = sprintf("SELECT * "
                ...
                . "JOIN prospective p ON p.jambregid = st.can_no "
                . "AND st.status = 'APPROVED' AND st.sesid = %s "
                . "JOIN programme pgm ON p.progoffered = pgm.progid  "
                . "WHERE st.reg_fee = 'FALSE' %s",  
...
if(isset($_POST['update']) && $_POST['update'] == 'yes'){
    $updateSQL = sprintf("UPDATE  schfee_transactions "
            . "SET reg_fee = 'TRUE', process_by = %s, process_date = CURDATE() "
            . "WHERE ordid = %s ", 
                            ...
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3><i class="icon-barcode"></i>
                                        T.M.F.B Registration Fees Payments 
                                    </h3>
                                    <ul class="tabs">
                                        <li class="active">
                                        ...
                                        <li class="active">
                                            <a href="printlist.php" target="_new">Print List</a>
                                        </li>
                                    </ul>
                                </div>
                                                ...
                                                <table class="table  table-condensed table-striped table-hover">
                                                    ...
                                                    <tbody> 
                                                        <tr ng-repeat="cd in ver_code | filter : seed" class="fade in">
                                                            ...
                                                            <td>{{cd.progname}}</td>
                                                            <td>
                                                                <?php if(in_array(getAccess(), ['20','24', '23', '26'])){?>
                                                                    <a  
            ...
            <form method="post" action="<?= $editFormAction; ?>">
                <div class="modal-body">
                    <div class="alert alert-warning">
                        You have choose to activate Registration Payment for the student with the bellow information
                    </div>
                    <div class="well well-small">
                        <span><b>Student ID :</b> {{seletedItem.can_no}}</span><br/>
                        <span><b>Student ID :</b> {{seletedItem.matric_no}}</span><br/>
