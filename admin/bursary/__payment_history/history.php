...
if (isset($_POST['table'])) {
    ...
    switch ($_POST['table']) {
        ...
        case 'schfee':
            $querySQL = sprintf("UPDATE schfee_transactions SET stamped = 'Yes' WHERE ordid = %s", GetSQLValueString($_POST['ordid'], 'text'));
            $updateRS = mysql_query($querySQL, $tams) or die(mysql_error());
            $affetted_row = mysql_affected_rows();
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a target="tab" href="receipts/acceptance.php?stdid=<?= $row_sch_fee['can_no']?>&no=<?= $row_sch_fee['ordid'] ?>" class="btn btn-small btn-gray">Receipt</a>
                                                            <?php } else { ?>
                                                                <form method="post" action="<?= $editFormAction; ?>">
                                                                    <button type="submit" name="submit" class="btn btn-small btn-blue">Stamped</button>
