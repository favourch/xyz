                                        ...
                                        <div class="row-fluid">
                                            <div class="span6">
                                                <div class="control-group">
                                                    <label class="control-label" for="textfield">Search Student Payment History (by Matric No, Surname or FirstName)</label>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php if( $num_row_search > 0){?>
                                                        ...
                                                        <tr>
                                                            <td><?= $i++; ?></td>
                                                            <td><a target="_tab" href="../../../student/profile.php?stid=<?=$row_search['stdid']?>"><?= $row_search['stdid']?></a></td>
