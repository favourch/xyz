...
$query = sprintf("SELECT * FROM olevel_veri_data olv, student st, programme pg, department d, college c "
                . "WHERE olv.stdid = st.stdid "
                . "AND st.progid = pg.progid "
                . "AND pg.deptid = d.deptid "
                . "AND d.colid = c.colid  "
                . "AND c.colid = %s "
                . "AND olv.treated = 'No' "
                . "AND olv.usertype = 'stud' "
                . "ORDER BY date ASC ", 
                            ...
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3><i class="icon-reorder"></i>
                                        Returning Student O'Level Verification Page (<?= $row_college['coltitle']?>)
                                    </h3>
                                    <ul class="tabs">
                                        <li class="active">
                                                    ...
                                                    <tbody>
                                                        <?php do { ?>
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="input-large" readonly value="<?php echo $verify_row['card_no']; ?>"></td>
                                                                <td><input type="text" class="input-large" readonly value="<?php echo $verify_row['card_pin']; ?>"></td>
