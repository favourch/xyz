                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3>
                                        <i class="icon-reorder"></i><?= ($_SESSION['olv_veri_who'] == 'pros')? 'Prospective ' : 'Returning '?> Student O'Level Verification Management Page
                                    </h3>
                                </div>
                                <div class="box-content">
                                    <form method="post" action="print_olevel.php" target="_tab" class="form form-horizontal" >
                                        <div class="row-fluid">
                                            <div class="span4">
