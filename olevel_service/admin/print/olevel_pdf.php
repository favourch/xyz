                                    ...
                                    <tr>
                                        <td>
                                            <p>
                                                ...
                                                <b>Exam Name :</b>".$olevel_data_row['result_plain']['result']['exam_name']." <br/>
                                                <b>Exam Type :</b>".$olevel_data_row['result_plain']['result']['exam_type']." <br/>
                                                <b>Exam Year :</b>".$olevel_data_row['result_plain']['result']['exam_year']." <br/>
                                                <b>Exam Number :</b>".$olevel_data_row['result_plain']['result']['exam_number']." <br/>
                                                <b>Candidate Name :</b>".$olevel_data_row['result_plain']['result']['candidate_name']."  <br/>
                                                <b>Exam Center :</b>".$olevel_data_row['result_plain']['result']['exam_center']."  <br/>
                                                <br/>
                                                <b>Subject/Score</b> 
                                                <table class='table table-sm'>
                                                    <tbody>";
                                                    foreach($olevel_data_row['result_plain']['result']['result'] AS $rs){
                                                    $html .= "<tr>
                                                            <td>".$rs['subject']."</td>
                                                            <td>".$rs['score']."</td>
                                                        </tr>";
