...
if($cur_college != -1){
    $query_part = sprintf("AND c.colid = %s ", GetSQLValueString($cur_college, 'int'));
}
...
$query_stud = sprintf("SELECT st.stdid, st.fname, st.lname, st.mname, st.jambregid, st.green_file, prg.progname FROM student st "
