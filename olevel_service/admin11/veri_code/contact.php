                            ...
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3><i class="icon-reorder"></i>
                                        Prospective Student O'Level Verification Code Contact List for (<?= $row_college['coltitle']?>) Treated by  <?= (getAccess() == 20) ? "ALL": getSessionValue('lname')." ".getSessionValue('fname')?>
                                    </h3>
<!--                                    <ul class="tabs">
                                        <li class="active">
                                ...
                                <div class="box-content">
                                    <div class="well well-small">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span3">
                                                <div class="control-group">
                                                    <label class="control-label" for="textfield">Search by Name or Jamb Reg. ID</label>
                                                    <div class="controls"> 
                                                        ...
                                                        <tr ng-repeat="cd in ver_code | filter : seed" class="fade in">
                                                                ...
                                                                <td ng-if="active">
                                                                    <div ng-if="!loading ">
                                                                        ...
                                                                        <span ng-if="cd.extra != '0' " class="badge badge-warning">Extra enabled</span>
                                                                    </div>
                                                                </td>
                                                                <?php if(in_array(getAccess(), ['20'])){?>
