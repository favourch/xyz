...
if (isset($_POST['MM_Submit']) && $_POST['MM_Submit'] == 'change_prog') {
    ...
    if ($_POST['action'] == 'yes') {
        ...
        $query = sprintf("UPDATE verification "
                        ...
                        . "released_by = %s, date_treated = CURDATE() "
                        . "WHERE id = %s ", 
                            ...
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3><i class="icon-reorder"></i>
                                        Programme Changed by   (<?= getSessionValue('uid')?>)
                                    </h3>
                                </div>
                                            ...
                                            <table class="table  table-condensed table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <tr ng-repeat="cd in ver_code| filter : seed">
                                                        ...
                                                        <td>{{cd.ver_code}}</td>
                                                        <td ng-if="active">
                                                            <a ng-if="cd.verified == 'FALSE'" href='#change_prog' data-toggle="modal"  ng-click="setSelected(cd)"class="btn btn-small btn-brown">Change Programme</a> 
