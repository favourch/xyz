...
//var_dump($_POST);
    ...
    $path = SITEURL."/olevel_service/client/olevel_veri_payment";
    ...
    if (!(curl_errno($ch) > 0)) {
        ...
        $sql = "INSERT INTO olevelverifee_transactions (can_no,can_name, reference, year, amt, status, date_time, ordid, sessionid,gatewayurl,percentPaid) VALUES('$canNo','$canName','$ref','$year', '$price' ,'$status' ,'$date','$orderid','$sessionid','$gateway_url','$percent')";
