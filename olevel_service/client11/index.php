                                                        ...
                                                        <table class="table table-bordered table-condensed table-striped table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr ng-repeat="dt in submission" ng-cloak="" ng-if="submission.length > 0">
                                                                    ...
                                                                    <td> 
                                                                        <a class="btn btn-small btn-success" ng-if="dt.approve != 'Yes'" href="fetch.php?id={{dt.resultid}}">Fetch Result</a>  
                                                                        <a class="btn btn-small btn-blue" 
                                                                           ng-if="dt.approve == 'Yes'" 
                                                                           href="#view_result" role="button" 
                                                                           data-toggle="modal" ng-click="setSelectedItem(dt)"> <i class="icon icon-eye-open"></i> View Result</a>
