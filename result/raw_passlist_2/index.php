                    ...
                    <div class="row-fluid">                        
                        <div class="span12">
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3>Passlist Migration Module</h3>
                                </div>
                                <div class="box-content">                                   
                                    <div class="row-fluid">
                                        <form name="summarysheet" method="post" target='_blank' action="migrate_passlist.php">
                                            <div class="row-fluid">
...
<!--                                                        <option value="<?php echo $duration + 1 ?>">Extra Year 1</option>
                                            ...
                                            <input type="submit" name="submit" id="submit" value="Get Pass List" 
