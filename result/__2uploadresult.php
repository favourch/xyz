...
if (isset($_GET['crs'])) {
    ...
    $queryCsType = sprintf("SELECT * FROM course "
                         . "WHERE csid = %s "
                         . "AND type = 'General' "
                         . "OR type = 'Enterpreneural'",
...
$query_crs = sprintf("SELECT csid "
        ...
        . "AND sesid=%s "
        . "AND deptid=%s %s "
        . "ORDER BY csid ASC", GetSQLValueString($colname2_crs, "int"), GetSQLValueString($colname_crs, "int"), $filter);
...
$query_ses = sprintf("SELECT DISTINCT s.sesname, t.sesid "
        ...
        . "AND t.lectid1=%s "
        . "ORDER BY s.sesname DESC", GetSQLValueString(getSessionValue('uid'), "text"));
...
$query_sescrs = sprintf("SELECT t.csid "
        ...
        . "WHERE t.sesid=%s "
        . "AND t.lectid1=%s "
        . "ORDER BY t.csid DESC", GetSQLValueString($colname_sescrs, "int"), GetSQLValueString(getSessionValue('uid'), "text"));
...
$query_rslt = sprintf("SELECT r.csid, r.edited, r.stdid, r.sesid, tscore, escore, s.fname, s.lname "
        ...
        . "AND r.sesid = t.sesid "
        . "AND r.sesid = %s "
        . "AND s.progid = p.progid", GetSQLValueString($colname2_rslt, "text"), GetSQLValueString($colname1_sescrs, "text"), GetSQLValueString($colname_sescrs, "int"));
...
$query_error = sprintf("SELECT count(*) as count "
        . "FROM result_error r "
        . "WHERE r.csid = %s "
        . "AND r.sesid = %s", GetSQLValueString($colname1_sescrs, "text"), GetSQLValueString($colname_sescrs, "int"));
                            ...
                            <div class="box box-bordered box-color">
                                ...
                                <div class="box-content">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div>
                                            No. Passed: <span id="pass"></span>
                                        </div>

                                        <div>
                                            No. Failed: <span id="fail"></span>
                                        </div>

                                        <div>
                                            Highest Score: <span id="high"></span>
                                        </div>

                                        <div>
                                            Lowest Score: <span id="low"></span>
                                        </div>
