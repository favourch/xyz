                                ...
                                <div class="box-content">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        if ($totalRows_rslt > 0) :
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="8"><div class="alert alert-error">Result not yet uploaded!</div></td>
                                            </tr>
<?php endif; ?>
                                    </table>
                                </div>
            ...
            <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade" 
                ...
                <div class="modal-body">
                    ...
                    <img src="../img/upload-help/1score.jpg"/>
                    <br/>
                    <h4>Step 2: Choose Save As</h4>
                    <img src="../img/upload-help/2save-as.jpg"/>
                    <br/>
                    <h4>Step 3: Specify File Name</h4>
                    <img src="../img/upload-help/3file-name.jpg"/>
                    <br/>
                    <h4>Step 4: Save as CSV Comma Delimiter</h4>
                    <img src="../img/upload-help/4csv-comma-delimited.jpg"/>
                    <br/>
                    <h4>Step 5: Save on Your Computer</h4>
                    <img src="../img/upload-help/5final-save.jpg"/>
                    <br/>
                    <h4>Step 6: Open the TAMS Result Upload Page</h4>
                    <img src="../img/upload-help/6upload-page.jpg"/>
                    <br/>
                    <h4>Step 7: Choose Result File to Upload Result</h4>
                    <img src="../img/upload-help/7choose-file.jpg"/>
                    <br/>
                    <h4>Step 8: Specify Session, Course & click Upload</h4>
                    <img src="../img/upload-help/8choose-course-to-upload.jpg"/>
                </div>
