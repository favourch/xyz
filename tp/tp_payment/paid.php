...
$paydesc = "ICT PROCESSING FEES PAYMENT";
...
//			$canNo=$row_rs_personal['Candidate_no'];
    ...
    $query_paid= sprintf("UPDATE tp_transactions
...
if($rsResult['email'] != NULL){
    ...
    $to = $rsResult['email'];
    $subject = "TASUED Portal: ICT Fees Payment";          
    $from = "noreply@tasued.edu.ng";
    $headers = "From: TASUED ".$from; 
    $body ="Good day {$portalName},\nYou have successfully paid your ICT fee\n==Payment Details==\n"
                . "Card PAN: {$pan}\nCard Holder: {$name}\nUnique ID: {$ordid}"
...
$query_paid= sprintf("SELECT * FROM tp_transactions WHERE ordid = %s",$ordid);
$paid= mysql_query($query_paid, $tams) or die(mysql_error());
$row_paid = mysql_fetch_assoc($paid);

 /// UPDATE POSITNG ACCEPTANCE
     $query_paid2= sprintf("UPDATE tp_student SET accepted = 'false' WHERE stdid= %s",GetSQLValueString(getSessionValue('MM_Username'), "text"));
                                ...
                                <div class="box-content">                                   
                                    <div class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <a class="btn btn-blue"target="_blank" href="../">
                                                <i class="icon-school">Choose new School</i>
                                            </a>
                                        </div>
