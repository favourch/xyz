   ...
   */ 
    {
      ...
      $register_student_sql = "UPDATE tp_student SET accepted  = 'false' WHERE stdid = $stdid";
       //print_r($register_student_sql); die();
...
if (isset($_POST['submit'])) {
  ...
  //REGISTER STUDENT 
    ...
    /// UPDATE  PAYMENT
    $register_student_sql = "UPDATE tp_transactions SET used = 'true' WHERE matric_no = $stdid";
    $register_student = query_result($register_student_sql);
                            ...
                            <div class="box box-color box-bordered">
                                ...
                                <div class="box-content">
                                    <?php if((count($registered_student) > 0)  AND (!isset($_POST['repost']))){?>
                                      ...
                                      <div class="well text-center text-success">
                                         <a href="index.php" class="btn btn-success"> BACK TO POSTING ADMIN </a>
                                      </div>
