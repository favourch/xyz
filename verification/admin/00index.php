...
$auth_users = "1,20,21, 22, 26,23,24";
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <ul class="tiles"> 
                                                ...
                                                <?php } ?>
                                                <?php if (in_array(getAccess(), ['20','21', '22'])) { ?>
                                                    <li class="teal">
                                                        <a href="print_olevel/index.php">
                                                ...
                                                <?php if (in_array(getAccess(), ['20', '24'])) { ?>
                                                    <li class="green">
                                                        <a href="change_prog/index.php">
                                                            <span><i class=" icon-book"></i></span>
                                                            <span class="name">Change Programme</span>
                                                        </a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
