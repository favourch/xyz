                            ...
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3><i class="icon-reorder"></i>
                                        Prospective Student O'Level Verification Code Generation Page (<?= $row_college['coltitle']?>) Treated by  <?= (getAccess() == 20) ? "ALL": getSessionValue('lname')." ".getSessionValue('fname')?>
                                    </h3>
<!--                                    <ul class="tabs">
                                        <li class="active">
