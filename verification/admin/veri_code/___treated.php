                            ...
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3><i class="icon-reorder"></i>
                                        Prospective Student O'Level Verification Code Generation Page (<?= $row_college['coltitle']?>) Treated by <?= getSessionValue('lname')." ".getSessionValue('fname')?>
                                    </h3>
<!--                                    <ul class="tabs">
                                        <li class="active">
                                ...
                                <div class="box-content">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span2"><b style="color:red">Total Released  : </b><?= $release_status ?></div>
                                        <div class="span2" ><b style="color:red">Total Refer : </b><?= $refere_status ?></div>
                                        <div class="span2" ><b style="color:red">Total Contact  : </b><?= $contact_status ?></div>
                                        <div class="span2" ><b style="color:red">Total Treated : </b><?= $total_count ?></div>
                                    </div>
                                    <div class='row-fluid'>
                                            <div class="span12">
                                                <div ng-if="loading">
                                                ...
                                                <table class="table  table-condensed table-striped table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Status</th>
                                                            <th width="30%" ng-if="active">Re-Process</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        <tr ng-repeat="cd in ver_code | filter : seed" class="fade in">
                                                                ...
                                                                <td ng-if="active">
                                                                    <div ng-if="!loading ">
                                                                        ...
                                                                        <span ng-if="cd.verified == 'TRUE'" class=" badge badge-important"> Student Already verified</span>
                                                                    </div>
                                                                </td>  
                                                            </tr>
                                                    </tbody>
