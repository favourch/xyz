...
if($_SESSION['olv_veri_who'] == 'stud'){
    ...
    $query = sprintf("SELECT v.*, p.stdid, p.stdid AS pstdid, p.fname, 
                        p.lname, p.mname,p.progid AS progoffered, prg.progname, 
                        ...
                        JOIN olevel_veri_data ovd ON ovd.stdid = v.stdid 
                            AND ovd.approve = 'Yes' %s 
                        WHERE v.sesid = %s 
                            AND v.status = '0' 
                            AND v.olevel_submit = 'TRUE' 
                        %s
                            GROUP BY(v.stdid)
                       ", 
...
$query = sprintf("SELECT v.*, p.pstdid, p.fname, 
                        ...
                        <div class="span12">
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    ...
                                    <ul class="tabs">
                                        <li class="active">
                                            <a href="treated.php" target="_new">My Treated</a>
                                        </li>
                                    </ul>
                                </div>
                                                        ...
                                                        <tr ng-repeat="cd in ver_code | filter : seed" class="fade in">
                                                                ...
                                                                <td>
                                                                    <div ng-if="!loading">
                                                                        ...
                                                                        <input type="button" name='refer' ng-click="refer($index, cd)" class="btn btn-small btn-blue" value="Contact"/>&nbsp;&nbsp;&nbsp;
                                                                        <?php } ?>
                                                                        
                                                                        <?php if(in_array(getAccess(), ['20','24','26','28'])){?>
                                                                        <div class="btn-group" ng-if="cd.extra == '0'">
                                                                            <button class="btn dropdown-toggle btn-small btn-red" data-toggle="dropdown">
                                                                                Extra
                                                                                <span class="caret"></span>
                                                                            </button>
                                                                            <ul class="dropdown-menu">
                                                                                <li>
                                                                                    <a href="#" ng-click="extraSubmission($index, cd, 1)">With Pay</a>
                                                                                </li>
                                                                                <?php if(in_array(getAccess(), ['20','26','28'])){?>
                                                                                <li>
                                                                                    <a href="#" ng-click="extraSubmission($index, cd, 2)" >Without Pay</a>
                                                                                </li>
                                                                                <?php }?>
                                                                            </ul>
                                                                        </div>
                                                                        <span ng-if="cd.extra == '1' " class="badge badge-warning">Extra with Pay Enabled</span>
                                                                        <span ng-if="cd.extra == '2' " class="badge badge-warning">Extra without Pay Enabled</span>
                                                                        <?php }?>
                                                                    </div>
                                                                </td>  
                                                            </tr>
...
<?php include INCPATH . "/footer.php" ?>
        ...
        <script>
            ...
            app.controller('pageCtrl', function($scope, $http){
                ...
                $scope.refer = function(index, obj){
                        $scope.loading = true;
                        $http({
                            method : "POST",
                ...
                $scope.extraSubmission = function(index, obj, id){
                        $scope.loading = true;
                        $http({
                            method : "POST",
