...
// Retreive all states
$state_query = sprintf("SELECT * FROM state");
...
// Retreive all lgas
$lga_query = sprintf("SELECT * FROM state_lga");
$lga = mysql_query($lga_query, $tams);
$totalRows_lga = mysql_num_rows($lga);

$lga_array = array();
if($totalRows_lga > 0){
    for(; $lgaRS = mysql_fetch_assoc($lga); ){
        array_push($lga_array, $lgaRS); 
    }
}
...
if(isset($_POST['o_level_result'])){
    ...
    if(!empty($_POST['olevel'])){
        ...
        if ($totalRows_rsid > 0) {
            for ( ;$row_rsid = mysql_fetch_assoc($rsid);) {
                $olevelid = $row_rsid['olevelid'];
                mysql_query("DELETE FROM olevelresult WHERE olevelid = {$row_rsid['olevelid']}", $tams);
                mysql_query("DELETE FROM olevel WHERE olevelid = {$row_rsid['olevelid']}", $tams);
...
if (isset($_POST['frmsubmit'])) {
    ...
    if(empty($miss)){
        ...
        $query_update = sprintf("UPDATE prospective "
                . "SET formsubmit = %s, formnum = %s, submit_date = %s "
                . "WHERE jambregid=%s", GetSQLValueString("Yes", "text"), GetSQLValueString($formnum, "text"), GetSQLValueString(date('Y-m-d'), "text"), GetSQLValueString($jambregid, "text"));
                                                                            ...
                                                                            <div class="row-fluid">
                                                                                    ...
                                                                                    <div class="control-group">
                                                                                        ...
                                                                                        <div class="controls">
                                                                                            <select name="stid" id="religion" class="input-medium" ng-model="stid" ng-change="getLga(stid)">
                                                                                                <option ng-repeat="state in state"   value="{{state.stid}}" ng-selected="state.stid == <?= $prospective_row['stid'] ?>">{{state.stname}}</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="control-group">
                                                                                ...
                                                                                <div class="span6">
                                                                                    ...
                                                                                    <div class="control-group">
                                                                                        ...
                                                                                        <div class="controls" ng-if="!lga_loading">
                                                                                            <select name="lga" id="religion" class="input-large">
                                                                                                <option ng-repeat="l in lga.rs" value="{{l.lgaid}}" ng-selected=" l.lgaid == <?= $prospective_row['lga'] ?>">{{l.lganame}}</option>
                                                                                            </select>
                                                                                        </div>
                                                                                        <div class="controls" ng-if="lga_loading">
                                                                                            <img src="../admin/disciplinary/giphy.gif" height="20" width="20">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="control-group">
                                                                                ...
                                                                                <div class="well well-large">
                                                                                    <table  class="table table-hover table-striped table-bordered table-condensed">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <input name="olevel[0][exam_num]" 
                                                                                                       type="text" id="examnumber"  required="" class="input input-medium" size="10" value="<?php echo $row_rssit1['examnumber'] ?>"  />
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="133">
                                                                                                ...
                                                                                                <select name="olevel[0][exam_type]" class="input input-large" id="exmtyp" style="width: 85px" required="" >
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>Exam Year : </td>
                                                                                            <td>
                                                                                                <input name="olevel[0][exam_year]" class="input input-medium" required="" type="text" id="exmyr" size="8" value="<?php echo $row_rssit1['examyear'] ?>" maxlength="4"  />
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        for ($i = 1; $i <= $totalRows_rssit1; $i++) {
                                                                                            ...
                                                                                            $row_rssit1 = mysql_fetch_assoc($rssit1);
                                                                                                ...
                                                                                                $count_left = (9 - $totalRows_rssit1)
                                                                                            ?>
                                                                                        <?php for ($j = $totalRows_rssit1+1; $j <= 9; $j++) { ?>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <select name="olevel[0][subject][<?= $j ?>]" id="subj['name'][]" class="input input-large" >
                                                                                                        <option value="">--Choose--</option>
                                                                                                        <?php
                                                                                                        do {
                                                                                                            ?>
                                                                                                ...
                                                                                                <td>
                                                                                                    <select name="olevel[0][grade][<?= $j ?>]" id="subj['grade'][]" class="input input-mini" >
                                                                            ...
                                                                            <div class="span6" >
                                                                                <div class="well well-large" ng-if="sit2">
                                                                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                                                                        ...
                                                                                        for ($k = 1; $k <= $totalRows_rssit2; $k++) {
                                                                                            ?>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <select name="olevel[1][subject][<?= $k ?>]" id="subj2['name'][]" class="input input-large" >
                                                                                                        <option value="">--Choose-</option>
                                                                                                        <?php do { ?>
                                                                                                ...
                                                                                                <td>
                                                                                                    <select name="olevel[1][grade][<?= $k ?>]" id="subj2['grade'][]"  class="input input-mini">
                                                                                                        <option value="">grade</option>
                                                                                                        <?php do { ?>
                                                                                        ...
                                                                                        $count_left2 = (9 - $totalRows_rssit2)
                                                                                        ?>


                                                                                        <?php for ($l = $totalRows_rssit2+1; $l <= 9; $l++) { ?>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <select name="olevel[1][subject][<?= $l ?>]" id="subj2['name'][]" class="input input-large">
                                                                                                        <option value="-1">--Choose-</option>
                                                                                                        <?php do { ?>
                                                                                                            <option value="<?php echo $row_rssubj['subjid'] ?>"><?php echo $row_rssubj['subjname'] ?></option>
                                                                                                            <?php
                                                                                                ...
                                                                                                <td>
                                                                                                    <select name="olevel[1][grade][<?= $l ?>]" id="subj2['grade'][]" class="input input-mini" >
                                                                                                        <option value="-1">grade</option>
                                                                                                        <?php do { ?>
                                                                                                            <option value="<?php echo $row_rsgrd['grdid'] ?>"><?php echo $row_rsgrd['grdname'] ?></option>
                                                                                                            <?php
...
<?php include INCPATH . "/footer.php" ?>
    ...
    <script>
        ...
        app.controller('MainCtrl', function($scope, $http){
            ...
            $scope.prev_school = [];
            $scope.stage = '<?= $stage?>';
            $scope.state = <?= json_encode($state_array)?>;
            ...
            $scope.lga.rs = <?= json_encode($lga_array)?>;
            ...
            $scope.getLga = function(stid){
                ...
                if(stid != ''){
                    $http({
                        ...
                        $scope.lga_loading = false; 
                    }, function myError(response) {
                        $scope.lga = response.statusText;
                        $scope.lga_loading = false; 
                        alert("Unable to fetch LGA  for the selected State check your Internet connection");
