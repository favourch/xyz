...
if(strpos($referer, 'fee_payment/mastercard/mastercard') == false) {
...
$penalty = $_SESSION['payment']['penalty'];
    
$pay_status = checkPaymentPros($sesid, $jambregid, $amount, 'sch'); // change to just scheduleid
                                ...
                                <div class="box-content">                                   
                                    <div class="row-fluid">
                                        ...
                                        <table class="table table-striped table-bordered table-condensed">
                                            ...
                                            <tr>
                                                <th>Penalty : </th>
                                                <th style="color: #CC0000"><?php echo '=N= ' . number_format($penalty); ?></th>
                                            </tr>
                                            <?php endif;?>
