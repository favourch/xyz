...
$pay_status = checkPaymentPros($sesid, $jambregid, $amount, 'acc');
                            ...
                            <div class="box box-bordered box-color">
                                <div class="box-title">
                                    <h3><i class="icon-reorder"></i>
                                        <?php echo $sesname?> Acceptance Payment
                                    </h3>
                                </div>
                                <div class="box-content">                                   
                                    <div class="row-fluid">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $owing['desc'] ?> Acceptance Fee</td>
                                                        <td>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <p>
                                                You do not owe this payment (<?php echo $sesname?> Acceptance fee)!
                                            </p>
                                            <br/>
