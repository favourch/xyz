...
if (strpos($referer, 'acceptance_payment/mastercard/index' == false) && !isset($_SESSION['payment']['gateway'])) {
...
if(!isset($_SESSION['payment']['gateway'])) {
    if (isset($_POST['paynow']) && isset($_SESSION['payment'])) {
        ...
        $path = SITEURL."/admission/acceptance_payment";
        ...
        if (!(curl_errno($ch) > 0)) {
            ...
            $sql = sprintf("INSERT INTO accfee_transactions "
