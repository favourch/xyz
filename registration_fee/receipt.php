...
$query_history = sprintf('SELECT p.fname, p.lname, p.mname, r.can_no, r.can_name, r.ordid, r.status, r.reference, r.amt, r.date_time, r. pcount '
                        . "FROM registration_transactions r JOIN prospective p ON p.jambregid = r.can_no "
                        . "WHERE can_no = %s "
                        . "AND status = 'APPROVED' "
                        . "AND ordid = %s ", 
...
if($totalRows_history > 0) {
    $html ='<p style="text-align:center; font-size: 20pt; margin-bottom: 30px"><strong>REGISTRATION PAYMENT RECEIPT</strong></p>
    <div style="text-align:center; width:100%; font-size: 20pt">
        <table align="center" style="width: 60%;" class="table table-bordered table-striped">
           ...
           <tr>
                ...
                <td>Description:</td>
                <td>REGISTRATION PAYMENT RECEIPT</td>
