...
if (isset($_POST['paynow']) && isset($_POST['stdid']) && $_POST['form_trig'] == 'form1') {
    ...
    $description = $revhead . "^registration fee/" . $sesid . "/" . $canNo . "^" . $purpose . "^";

    $path = SITEURL."/registration_fee";
    ...
    if (!(curl_errno($ch) > 0)) {
        ...
        $sql = sprintf("INSERT INTO registration_transactions "
                    ...
                    GetSQLValueString('NGN'.number_format($_POST['amount'], 2), "text"),
