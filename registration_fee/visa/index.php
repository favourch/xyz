...
$totalRows_rspros = '';
    ...
    $query_rspros = sprintf("SELECT *  
                                    FROM prospective  
                                    WHERE jambregid =%s", GetSQLValueString(getSessionValue('uid'), "text"));
...
$query_paid = sprintf("SELECT * FROM registration_transactions  "
                                                ...
                                                <td colspan="2">
                                                    <table width="200" align="center" >
                                                        <form name="form1" method="post" action="<?php echo "processpayment.php" ?>">
                                                            ...
                                                            <input type="hidden" name="stdid" value="<?php echo  $row_rspros['jambregid']?>"/>
