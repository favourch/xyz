    ...
    <form class="form-vertical" method="post" action="profile.php" enctype="application/x-www-form-urlencoded">
        <div class="modal-body" style="min-height: 300px">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls" >
                            <select id="pub_type" required="" name="pub_type" class="input-small" >
                                ...
                                <option value="tech_report">Technical Report</option>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" required="" name="auth_name" id="auth_name" class="" value="">
                </div>
            </div>
            <div class="control-group">
    ...
    <form class="form-vertical" method="POST" action="profile.php" enctype="application/x-www-form-urlencoded">
        <div class="modal-body" style="min-height: 350px">
            ...
            <div class="row-fluid">
                ...
                <div class="span3">
                    <div class="control-group">
                        <label class="control-label" for="r_area">Research Area</label>
                        <div class="controls">
                            <select name="r_area"  id="r_area" class="input-block-level">
                                <option value="">--Choose--</option>
                                <option value="science" ng-selected="selectedItem.res_area == 'science'">Science</option>
                                <option value="art" ng-selected="selectedItem.res_area == 'art'">Art</option>
                                <option value="humanity" ng-selected="selectedItem.res_area == 'humanity'">Humanity</option>
                                <option value="management" ng-selected="selectedItem.res_area == 'management'">Management</option>
                                <option value="educational" ng-selected="selectedItem.res_area == 'educational'">Education</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="span3">
                    <div class="control-group">
                        <label class="control-label" for="pub_type">Publication Type</label>
                        <div class="controls" >
                            <select id="pub_type"  name="pub_type" class="input-block-level" >
                                <option value="">--Choose--</option>
                                <option value="conference" ng-selected="selectedItem.pub_type == 'conference'">Conference</option>
                                <option value="journals" ng-selected="selectedItem.pub_type == 'journals'">Journals</option>
                                <option value="tech_report" ng-selected="selectedItem.pub_type == 'tech_report'">Technical Report</option>
                                <option value="presentation" ng-selected="selectedItem.pub_type == 'presentation'">Presentation</option>
                                <option value="book_section" ng-selected="selectedItem.pub_type == 'book_section'">Book Section,</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="reference" class="input-block-level"  id="reference2" value="{{selectedItem.reference}}">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="pub_at">Published At</label>
