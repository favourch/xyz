...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    $updateSQL = sprintf("UPDATE department SET deptname=%s, page_up=%s, page_down=%s WHERE deptid=%s", GetSQLValueString($_POST['deptname'], "text"), GetSQLValueString($_POST['page_up'], "text"), GetSQLValueString($_POST['page_down'], "text"), GetSQLValueString($_POST['deptid'], "int"));
                                ...
                                <div class="box-content nopadding">
                                    <form class="form-horizontal form-bordered" method="POST" action="#">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text"  class="input-xxlarge" name="deptname" value="<?php echo htmlentities($row_editdept['deptname'], ENT_COMPAT, 'utf-8'); ?>" size="50" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <textarea name="page_up" cols="60" rows="5"  class="input-xxlarge"><?php echo htmlentities($row_editdept['page_up'], ENT_COMPAT, 'utf-8'); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <textarea name="page_down" cols="60" rows="5"  class="input-xxlarge"><?php echo htmlentities($row_editdept['page_down'], ENT_COMPAT, 'utf-8'); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
