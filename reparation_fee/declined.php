...
if (isset($_POST["xmlmsg"])) {
    ...
    $update = sprintf("UPDATE reparation_transactions SET amt='0',resp_code='" . $rc . "',resp_desc = '" . $res . "', auth_code='" . $ac . "', pan='" . $pan . "', status = 'DECLINED', name='" . $name . "', date_time='" . $dt . "', xml = '" . $xmlmsg . "' WHERE  ordid='" . $ordid . "'");
...
mysql_select_db($database_tams, $tams);
$query_paid = sprintf("SELECT * FROM reparation_transactions WHERE ordid=%s", $ordid);
