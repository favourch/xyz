...
if(!in_array($row_stud['level'], [2,3,4,5])){
                                ...
                                <div class="box-content">    
                                    ...
                                    <table  class="table ">
                                            <tr>
                                                <td colspan="2">
                                                    <p>
                                                        Your Reparation fee is to be paid by selecting a card type below and using our webpay platform.
                                                    </p>
