...
$query_feehistory = sprintf('SELECT matric_no, ordid, status, reference, amt, date_time, stamped '
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($row_feehistory['status'] == 'APPROVED') { ?>
                                                                    <?php if($row_feehistory['stamped'] == "yes") {?>
                                                                <span class="badge badge-warning" title="Contact Bursary Department for reprint">Stamped</span>
                                                                    <?php }else{?>
