...
$query_feehistory = sprintf('SELECT matric_no, ordid, status, reference, amt, date_time, reg_fee, pcount '
                                                ...
                                                if ($totalRows_feehistory > 0) {
                                                    for ($idx = 0; $idx < $totalRows_feehistory; $idx++, $row_feehistory = mysql_fetch_assoc($feehistory)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($row_feehistory['status'] == 'APPROVED' && $row_feehistory['pcount'] <2) { ?>
